namespace Sitecore.Feature.Search.Controllers
{
    ...
    public class SearchControllerSolr : Controller
    {
        public SearchControllerSolr(ISearchContextRepository contextRepository, FacetQueryStringService facetQueryStringService, SearchService searchService, IRenderingPropertiesRepository renderingPropertiesRepository)
        {
        ...
        public ActionResult GlobalSearchSolr()
        {
        ...
        public ActionResult AjaxSearchResults(string query)
        {
            ...
            var searchResults = this.SearchService.SearchFromTopResultsSolr(query, 5); 

namespace Sitecore.Foundation.Indexing.Repositories
{
    ...
    public class SearchResultsFactory
    {
        ...
        public void CreateSolr(System.Linq.IQueryable<SearchResultItem> results, IQuery query)
        {
            //var searchResults = results..Select(h => SearchResultFactory.Create(h.Document)).ToArray();
        }
